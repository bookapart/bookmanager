    ...
    .forEach((book) => {
      ...
      card.innerHTML = `
        ...
        <div class="book-details">
          ...
          <div class="thumbnail"><img onclick="showGallery(this);" onerror="this.src='./assets/isbn/nocover.jpg';" src="./assets/isbn/${book.book_isbn}.jpg" /></div>
          ...
          ${book.book_count == 0 ? `<img src="./assets/images/mark.svg" style="position:absolute; width:18rem; left:50%; margin-left:-9rem; top:15%; pointer-events:none; opacity:.9" />` : ""}
        </div>
      `;
